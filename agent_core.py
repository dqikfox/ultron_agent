...
class UltronAgent:
    ...
    async def enhance_messages_with_context(self, messages: List[Dict], session_id: str) -> List[Dict]:
        ...
        system_prompt = {
            "role": "system",
            "content": """You are ULTRON, an advanced AI assistant. You have the following capabilities:
...
Personality: Professional yet approachable, focusing on practical solutions."""
        }
    ...
    <div class="container">
        ...
        <div class="messages" id="messages">
            <div class="message assistant">
                ULTRON Agent Core is online and ready.
                Connected to NVIDIA API with multiple model support.
            </div>
        </div>
...
if __name__ == "__main__":
    ...
    asyncio.run(agent.start())
            ...
            print("\nShutting down GUI... - agent_core.py:550")
    else:
        agent.start()
```.com9
