@echo off
chcp 65001 > nul
title ULTRON Agent 3.0 - Complete Syst:: Launchecho 🏠 [1/5] Starting Main POecho 🔗 AVAILABLE ENDPOINTS:
echo    🏠 Main GUI:       http://localhost:5000  (POKÉDX INTERFACE - START HERE!)
...
echo    🌉 Web Bridge:     Background Service     (Connection Manager)nterface (Port 5000)...
echo      URL: http://localhost:5000 (SOPHISTICATED GUI - MAIN ENTRY)
start "ULTRON Main GUI" cmd /c "python main_gui_server.py > logs\main_gui.log 2>&1"
timeout /t 3 >nuluence
